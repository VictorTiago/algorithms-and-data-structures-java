...
public class C13EXEXTRA03FichaIrpf extends C13EXEXTRA03Irpf{
    ...
    public C13EXEXTRA03FichaIrpf() {
    }

    public C13EXEXTRA03FichaIrpf(double salario, int qntDep, String nome) {
